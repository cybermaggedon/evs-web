...
export class ResourceService {
    ...
    Observable<ResourceThreats> {

	let obs = new Observable<ResourceThreats>();

	const devicify = map((g : Graph) => {

	    let dt = new ResourceThreats();
        ...
        return devicify(this.tgSvc.getResourceThreats(id, from, to));
